...
function(set_target_properties_plugin target)
  ...
  configure_file(cmake/macos/resources/create-package.cmake.in "${CMAKE_BINARY_DIR}/create-package.cmake")
  install(SCRIPT "${CMAKE_BINARY_DIR}/create-package.cmake")
endfunction()
